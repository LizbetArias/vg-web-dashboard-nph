...
export class FamilyPdfService {
    ...
    generateDetailedFamilyReport(family: Family, familyMembers: Person[]): void {
        ...
        const housingData = [
            ['Tenencia', family.housingDetails.tenure || 'No especificado'],
            ...
            ['Número de Habitaciones', family.housingDetails.bedroomNumber?.toString() || 'No especificado'],
            ['Habitabilidad', family.housingDetails.habitability || 'No especificado'],
            ['Condicion', family.housingDetails.caregiverCondition || 'No especificado']
        ];
