                ...
                if (familyPersons.length === 0) {
                    ...
                    familyPersons.forEach((person, index) => {
                        dataToExport.push({
                            ...
                            'Tenencia': family.housingDetails.tenure,
                            ...
                            'N° de Habitaciones': family.housingDetails.bedroomNumber,
                            'Habitabilidad': family.housingDetails.habitability,

                            'Condicion Laboral Cuidador': family.housingDetails.caregiverCondition,
                            'Condicion Laboral Cuidadora': family.housingDetails.caringCondition,
                            'N° de Trabajadores': family.housingDetails.membersWork,
                            'Tiempo de trabajos Hr': family.housingDetails.workingTime,
                            'Ingresos Mensual': family.housingDetails.monthlyIncome,
                            'Egresos Mensual': family.housingDetails.monthlyExpense,
